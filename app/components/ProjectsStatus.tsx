    ...
    return (
      <div className="bg-blue-400 p-5 rounded-3xl shadow-md w-1/2 flex flex-col justify-between">
        ...
        <p className="font-semibold text-sm md:text-lg text-white">
          <Link href={emojihack.aboutPath} className="underline" target="_blank">{emojihack.preferredName}</Link> has launched {associatedEmojisCount} emoji projects out of {totalEmojisCount} emojis.
        </p>
